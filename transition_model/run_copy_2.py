...
# -*- coding: utf-8 -*-
"""
Created on Mon Sep 26 22:34:45 2022
...
parser.add_argument('--model', type=str,  default="new_model_4",help='model select')
...
parser.add_argument('--label_type', type=str,  default='binary',help='model select')
...
MODEL_SAVE = 'BEST_MODEL/{}_test/'.format(args.model)
RESULT_SAVE = 'result/{}_test.csv'.format(args.model)
IMG_SAVE = 'images/{}_test/'.format(args.model)
...
for fold, (train_index, valid_index) in enumerate(skf.split(TRAIN_RECORDING)):
    ...
    model = ATT_NEW_4(talk_fea=1, talk_hidden=4, me_gaze_fea = 4, me_gaze_hidden = 4, gaze_fea = 1, gaze_hidden = 4, char_hidden=4,
